...
INSERT INTO recipe (recipe_id, user_id, recipe_name, ready_in_minutes, serving, recipe_ingredients, image, instructions) VALUES (4,1, 'Vegetarian stew', '27', '5',
...
'1 cup dry green lentils or black lentils,Seeds of 1 pomegranate,Water,Kosher salt,1 small red onion chopped,¾ English cucumber small diced or chopped (about 2 ½ cups),2 to 3 cups baby spinach or other leafy green of choice,1 cup chopped fresh parsley,Crumbled feta cheese for garnish,Lime Dressing:,¼ cup fresh lime juice,¼ Tbs extra virgin olive oil,2 tsp honey,1 tsp ground cumin,½ tsp ground allspice,Salt and pepper',
